        ...
        <section className="bg-white rounded-xl shadow-card p-6">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border-light">
                  <th className="text-left py-3 px-4 text-sm font-medium text-text-secondary">组件名称</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-text-secondary">版本</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-text-secondary">许可证</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-text-secondary">供应商</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-text-secondary">类型</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-text-secondary">描述</th>
                </tr>
              </thead>
              <tbody>
                {currentPageComponents.map((component, index) => (
                  <tr key={index} className={`${styles.tableRow} border-b border-border-light`}>
                    ...
                    <td className="py-3 px-4">
                      <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs">{component.license}</span>
                    </td>
                    <td className="py-3 px-4 text-sm text-text-secondary">{component.supplier}</td>
                    <td className="py-3 px-4">
                      <span className="px-2 py-1 bg-gray-100 text-gray-800 rounded text-xs">{component.type}</span>
                    </td>
                    <td className="py-3 px-4 text-sm text-text-secondary">{component.description}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="flex items-center justify-between mt-6">
            <div className="text-sm text-text-secondary">
              显示 <span>{start}</span> 到 <span>{end}</span> 条，共 <span>{filteredComponents.length}</span> 条记录
            </div>
