  ...
  return (
    <div className={styles.pageWrapper}>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button className="flex items-center space-x-2 p-1 rounded-lg hover:bg-gray-50">
                <img 
                  src="https://s.coze.cn/image/_VPgZH403x4/" 
                  alt="用户头像" 
      ...
      <main className="ml-64 mt-16 p-6 min-h-screen">
        ...
        {/* 成功提示消息 */}
        {showSuccessMessage && (
          <div className={`bg-success bg-opacity-10 border border-success border-opacity-20 text-success px-4 py-3 rounded-lg mb-6 ${styles.successMessage}`}>
        ...
        {/* 错误提示消息 */}
        {showErrorMessage && (
          <div className={`bg-danger bg-opacity-10 border border-danger border-opacity-20 text-danger px-4 py-3 rounded-lg mb-6 ${styles.successMessage}`}>
            <div className="flex items-center">
          ...
          <form onSubmit={handleProfileSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-6">
                <div className="relative">
                  <img 
                    src="https://s.coze.cn/image/VpvA04RECrM/" 
                    alt="当前头像" 
                ...
                {showAvatarUploadArea && (
                  <div className={`${styles.avatarUploadArea} flex-1 max-w-md h-32 rounded-lg flex flex-col items-center justify-center cursor-pointer`}>
            ...
            {/* 部门 */}
            <div className="space-y-2">
              <label htmlFor="department" className="block text-sm font-medium text-text-primary">所属部门</label>
              <input 
                type="text" 
                id="department" 
                name="department" 
